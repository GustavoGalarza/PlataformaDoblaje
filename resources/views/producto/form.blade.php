<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            <label for="categoriaid" class="form-label">{{ __('Categoriaid') }}</label>
            <input type="text" name="categoriaid" class="form-control @error('categoriaid') is-invalid @enderror" value="{{ old('categoriaid', $producto?->categoriaid) }}" id="categoriaid" placeholder="Categoriaid">
            {!! $errors->first('categoriaid', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
